  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, {:bar => invalid_attributes}, valid_session
        expect(response).to be_success
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested bar" do
        bar = Bar.create! valid_attributes
        put :update, {:id => bar.to_param, :bar => new_attributes}, valid_session
        bar.reload
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        bar = Bar.create! valid_attributes
        put :update, {:id => bar.to_param, :bar => invalid_attributes}, valid_session
        expect(response).to be_success
      end
    end
  end
